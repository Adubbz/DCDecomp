...
/* 100640 00200540 C0FFBD27 */  addiu       $29, $29, -0x40
/* 100644 00200544 3000BF7F */  sq          $31, 0x30($29)
/* 100648 00200548 2000B27F */  sq          $18, 0x20($29)
/* 10064C 0020054C 1000B17F */  sq          $17, 0x10($29)
/* 100650 00200550 0000B07F */  sq          $16, 0x0($29)
...
/* 100664 00200564 DA01013C */  lui         $1, %hi(WepMenu + 0x6)
/* 100668 00200568 76EA2380 */  lb          $3, %lo(WepMenu + 0x6)($1)
/* 10066C 0020056C 0E006010 */  beqz        $3, .L002005A8
/* 100670 00200570 00000000 */   nop
/* 100674 00200574 09000224 */  addiu       $2, $0, 0x9
/* 100678 00200578 DA01013C */  lui         $1, %hi(WepMenu + 0x2)
/* 10067C 0020057C 72EA22A4 */  sh          $2, %lo(WepMenu + 0x2)($1)
...
/* 100698 00200598 DA01013C */  lui         $1, %hi(WepMenu + 0x20)
/* 10069C 0020059C 90EA23AC */  sw          $3, %lo(WepMenu + 0x20)($1)
/* 1006A0 002005A0 7C000010 */  b           .L00200794
/* 1006A4 002005A4 00000000 */   nop
.L002005A8:
/* 1006A8 002005A8 08000324 */  addiu       $3, $0, 0x8
/* 1006AC 002005AC DA01013C */  lui         $1, %hi(WepMenu + 0x2)
/* 1006B0 002005B0 72EA23A4 */  sh          $3, %lo(WepMenu + 0x2)($1)
...
/* 1006D8 002005D8 DA01013C */  lui         $1, %hi(WepMenu + 0x1C)
/* 1006DC 002005DC 8CEA248C */  lw          $4, %lo(WepMenu + 0x1C)($1)
...
.L00200600:
/* 100700 00200600 7495848F */  lw          $4, -0x6A8C($28)
/* 100704 00200604 10B9080C */  jal         InitHaveData__FP9IHAVEITEM
/* 100708 00200608 00000000 */   nop
/* 10070C 0020060C DA01023C */  lui         $2, %hi(WepMenu + 0x150)
/* 100710 00200610 C0EB4424 */  addiu       $4, $2, %lo(WepMenu + 0x150)
...
.L00200630:
/* 100730 00200630 D494828F */  lw          $2, -0x6B2C($28)
/* 100734 00200634 04054324 */  addiu       $3, $2, 0x504
/* 100738 00200638 F87F6324 */  addiu       $3, $3, 0x7FF8
/* 10073C 0020063C DA01013C */  lui         $1, %hi(WepMenu + 0x20)
/* 100740 00200640 90EA228C */  lw          $2, %lo(WepMenu + 0x20)($1)
/* 100744 00200644 40110200 */  sll         $2, $2, 5
/* 100748 00200648 21806200 */  addu        $16, $3, $2
/* 10074C 0020064C 00000286 */  lh          $2, 0x0($16)
/* 100750 00200650 51004128 */  slti        $1, $2, 0x51
/* 100754 00200654 06002010 */  beqz        $1, .L00200670
/* 100758 00200658 00000000 */   nop
/* 10075C 0020065C 7495828F */  lw          $2, -0x6A8C($28)
...
/* 1007DC 002006DC DA01013C */  lui         $1, %hi(WepMenu + 0x6)
/* 1007E0 002006E0 76EA23A0 */  sb          $3, %lo(WepMenu + 0x6)($1)
...
/* 1007F4 002006F4 DA01023C */  lui         $2, %hi(WepMenu + 0x150)
/* 1007F8 002006F8 C0EB4424 */  addiu       $4, $2, %lo(WepMenu + 0x150)
...
/* 100874 00200774 D494828F */  lw          $2, -0x6B2C($28)
...
.L00200794:
/* 100894 00200794 3000BF7B */  lq          $31, 0x30($29)
/* 100898 00200798 2000B27B */  lq          $18, 0x20($29)
/* 10089C 0020079C 1000B17B */  lq          $17, 0x10($29)
/* 1008A0 002007A0 0000B07B */  lq          $16, 0x0($29)
/* 1008A4 002007A4 4000BD27 */  addiu       $29, $29, 0x40
