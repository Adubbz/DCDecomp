...
/* 00D7C0 0010D6C0 2A00033C */  lui         $3, %hi(initialized.40)
/* 00D7C4 0010D6C4 D0FFBD27 */  addiu       $29, $29, -0x30
/* 00D7C8 0010D6C8 584F628C */  lw          $2, %lo(initialized.40)($3)
...
/* 00D7DC 0010D6DC 2A00113C */  lui         $17, %hi(eh.39)
/* 00D7E0 0010D6E0 01000224 */  addiu       $2, $0, 0x1
/* 00D7E4 0010D6E4 484F3026 */  addiu       $16, $17, %lo(eh.39)
/* 00D7E8 0010D6E8 584F62AC */  sw          $2, %lo(initialized.40)($3)
...
/* 00D7FC 0010D6FC 2A00033C */  lui         $3, %hi(top_elt.41)
/* 00D800 0010D700 604F6324 */  addiu       $3, $3, %lo(top_elt.41)
/* 00D804 0010D704 02000010 */  b           .L0010D710
/* 00D808 0010D708 040003AE */   sw         $3, 0x4($16)
.L0010D70C:
/* 00D80C 0010D70C 2A00113C */  lui         $17, %hi(eh.39)
.L0010D710:
/* 00D810 0010D710 484F2226 */  addiu       $2, $17, %lo(eh.39)
