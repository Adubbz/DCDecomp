...
glabel BtCleatRandomMap__Fv
    ...
    /* 00CAC4 01DB87C4 0A000010 */  b          .L01DB87F0
  ...
  .L01DB883C:
    ...
    /* 00CB40 01DB8840 F2FF4014 */  bnez       $2, .L01DB880C
    /* 00CB44 01DB8844 00000000 */   nop
    /* 00CB48 01DB8848 28260070 */  paddub     $4, $0, $0
    /* 00CB4C 01DB884C 0D000010 */  b          .L01DB8884
  ...
  .L01DB8884:
    ...
    /* 00CB88 01DB8888 F2FF4014 */  bnez       $2, .L01DB8854
    ...
    /* 00CBA0 01DB88A0 07000010 */  b          .L01DB88C0
  ...
  .L01DB88C0:
    ...
    /* 00CBC4 01DB88C4 F8FF4014 */  bnez       $2, .L01DB88A8
    ...
    /* 00CBDC 01DB88DC 09000010 */  b          .L01DB8904
  ...
  .L01DB895C:
    ...
    /* 00CC60 01DB8960 EFFF6014 */  bnez       $3, .L01DB8920
    ...
    /* 00CC74 01DB8974 10000010 */  b          .L01DB89B8
  ...
  .L01DB89B8:
    ...
    /* 00CCBC 01DB89BC EFFF6014 */  bnez       $3, .L01DB897C
  ...
  .L01DB8A9C:
    ...
    /* 00CDB8 01DB8AB8 F8FF801C */  bgtz       $4, .L01DB8A9C
  ...
  .L01DB8AD4:
    ...
    /* 00CDE8 01DB8AE8 FAFF601C */  bgtz       $3, .L01DB8AD4
    ...
    /* 00CE08 01DB8B08 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x3B0)
    /* 00CE0C 01DB8B0C 904F20C4 */  lwc1       $f0, %lo(MainDungeonMap + 0x3B0)($1)
    /* 00CE10 01DB8B10 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x3B0)
    /* 00CE14 01DB8B14 A05A20E4 */  swc1       $f0, %lo(UraDungeonMap + 0x3B0)($1)
    /* 00CE18 01DB8B18 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x3B4)
    /* 00CE1C 01DB8B1C 944F228C */  lw         $2, %lo(MainDungeonMap + 0x3B4)($1)
    /* 00CE20 01DB8B20 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x3B4)
    /* 00CE24 01DB8B24 A45A22AC */  sw         $2, %lo(UraDungeonMap + 0x3B4)($1)
    /* 00CE28 01DB8B28 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x3B8)
    /* 00CE2C 01DB8B2C 984F228C */  lw         $2, %lo(MainDungeonMap + 0x3B8)($1)
    /* 00CE30 01DB8B30 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x3B8)
    /* 00CE34 01DB8B34 A85A22AC */  sw         $2, %lo(UraDungeonMap + 0x3B8)($1)
    /* 00CE38 01DB8B38 DC01023C */  lui        $2, %hi(MainDungeonMap + 0x3C0)
    /* 00CE3C 01DB8B3C A04F4624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x3C0)
    /* 00CE40 01DB8B40 DD01023C */  lui        $2, %hi(UraDungeonMap + 0x3C0)
    /* 00CE44 01DB8B44 B05A4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x3C0)
  ...
  .L01DB8B4C:
    ...
    /* 00CE68 01DB8B68 F8FF801C */  bgtz       $4, .L01DB8B4C
    /* 00CE6C 01DB8B6C 00000000 */   nop
    /* 00CE70 01DB8B70 DC01023C */  lui        $2, %hi(MainDungeonMap + 0x440)
    /* 00CE74 01DB8B74 20504624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x440)
    /* 00CE78 01DB8B78 DD01023C */  lui        $2, %hi(UraDungeonMap + 0x440)
    /* 00CE7C 01DB8B7C 305B4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x440)
  ...
  .L01DB8B84:
    ...
    /* 00CEA0 01DB8BA0 F8FF801C */  bgtz       $4, .L01DB8B84
    /* 00CEA4 01DB8BA4 00000000 */   nop
    /* 00CEA8 01DB8BA8 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x460)
    /* 00CEAC 01DB8BAC 4050228C */  lw         $2, %lo(MainDungeonMap + 0x460)($1)
    /* 00CEB0 01DB8BB0 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x460)
    /* 00CEB4 01DB8BB4 505B22AC */  sw         $2, %lo(UraDungeonMap + 0x460)($1)
    /* 00CEB8 01DB8BB8 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x464)
    /* 00CEBC 01DB8BBC 4450228C */  lw         $2, %lo(MainDungeonMap + 0x464)($1)
    /* 00CEC0 01DB8BC0 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x464)
    /* 00CEC4 01DB8BC4 545B22AC */  sw         $2, %lo(UraDungeonMap + 0x464)($1)
    /* 00CEC8 01DB8BC8 DC01013C */  lui        $1, %hi(MainDungeonMap + 0x468)
    /* 00CECC 01DB8BCC 4850228C */  lw         $2, %lo(MainDungeonMap + 0x468)($1)
    /* 00CED0 01DB8BD0 DD01013C */  lui        $1, %hi(UraDungeonMap + 0x468)
    /* 00CED4 01DB8BD4 585B22AC */  sw         $2, %lo(UraDungeonMap + 0x468)($1)
    /* 00CED8 01DB8BD8 DC01023C */  lui        $2, %hi(MainDungeonMap + 0x46C)
    /* 00CEDC 01DB8BDC 4C504324 */  addiu      $3, $2, %lo(MainDungeonMap + 0x46C)
    /* 00CEE0 01DB8BE0 DD01023C */  lui        $2, %hi(UraDungeonMap + 0x46C)
    /* 00CEE4 01DB8BE4 5C5B4224 */  addiu      $2, $2, %lo(UraDungeonMap + 0x46C)
    ...
    /* 00CF00 01DB8C00 DC01023C */  lui        $2, %hi(MainDungeonMap + 0x478)
    /* 00CF04 01DB8C04 58504624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x478)
    /* 00CF08 01DB8C08 DD01023C */  lui        $2, %hi(UraDungeonMap + 0x478)
    /* 00CF0C 01DB8C0C 685B4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x478)
  ...
  .L01DB8C14:
    ...
    /* 00CF30 01DB8C30 F8FF801C */  bgtz       $4, .L01DB8C14
    /* 00CF34 01DB8C34 00000000 */   nop
    /* 00CF38 01DB8C38 DC01023C */  lui        $2, %hi(MainDungeonMap + 0x490)
    /* 00CF3C 01DB8C3C 70504624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x490)
    /* 00CF40 01DB8C40 DD01023C */  lui        $2, %hi(UraDungeonMap + 0x490)
    /* 00CF44 01DB8C44 805B4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x490)
  ...
  .L01DB8C4C:
    ...
    /* 00CF68 01DB8C68 F8FF801C */  bgtz       $4, .L01DB8C4C
    /* 00CF6C 01DB8C6C 00000000 */   nop
    /* 00CF70 01DB8C70 DD01023C */  lui        $2, %hi(MainDungeonMap + 0x8710)
    /* 00CF74 01DB8C74 F0D24624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x8710)
    /* 00CF78 01DB8C78 DE01023C */  lui        $2, %hi(UraDungeonMap + 0x8710)
    /* 00CF7C 01DB8C7C 00DE4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x8710)
  ...
  .L01DB8C84:
    ...
    /* 00CFA0 01DB8CA0 F8FF801C */  bgtz       $4, .L01DB8C84
    /* 00CFA4 01DB8CA4 00000000 */   nop
    /* 00CFA8 01DB8CA8 DD01023C */  lui        $2, %hi(MainDungeonMap + 0x8D50)
    /* 00CFAC 01DB8CAC 30D94624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x8D50)
    /* 00CFB0 01DB8CB0 DE01023C */  lui        $2, %hi(UraDungeonMap + 0x8D50)
    /* 00CFB4 01DB8CB4 40E44524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x8D50)
  ...
  .L01DB8CBC:
    ...
    /* 00CFD8 01DB8CD8 F8FF801C */  bgtz       $4, .L01DB8CBC
    /* 00CFDC 01DB8CDC 00000000 */   nop
    /* 00CFE0 01DB8CE0 DD01023C */  lui        $2, %hi(MainDungeonMap + 0x9C50)
    /* 00CFE4 01DB8CE4 30E84624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x9C50)
    /* 00CFE8 01DB8CE8 DE01023C */  lui        $2, %hi(UraDungeonMap + 0x9C50)
    /* 00CFEC 01DB8CEC 40F34524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x9C50)
  ...
  .L01DB8CF4:
    ...
    /* 00D010 01DB8D10 F8FF801C */  bgtz       $4, .L01DB8CF4
    /* 00D014 01DB8D14 00000000 */   nop
    /* 00D018 01DB8D18 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xB550)
    /* 00D01C 01DB8D1C 30014624 */  addiu      $6, $2, %lo(MainDungeonMap + 0xB550)
    /* 00D020 01DB8D20 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xB550)
    /* 00D024 01DB8D24 400C4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0xB550)
  ...
  .L01DB8D2C:
    ...
    /* 00D048 01DB8D48 F8FF801C */  bgtz       $4, .L01DB8D2C
    /* 00D04C 01DB8D4C 00000000 */   nop
    /* 00D050 01DB8D50 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xB650)
    /* 00D054 01DB8D54 3002228C */  lw         $2, %lo(MainDungeonMap + 0xB650)($1)
    /* 00D058 01DB8D58 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xB650)
    /* 00D05C 01DB8D5C 400D22AC */  sw         $2, %lo(UraDungeonMap + 0xB650)($1)
    /* 00D060 01DB8D60 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xB660)
    /* 00D064 01DB8D64 40024624 */  addiu      $6, $2, %lo(MainDungeonMap + 0xB660)
    /* 00D068 01DB8D68 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xB660)
    /* 00D06C 01DB8D6C 500D4524 */  addiu      $5, $2, %lo(UraDungeonMap + 0xB660)
  ...
  .L01DB8D74:
    ...
    /* 00D090 01DB8D90 F8FF801C */  bgtz       $4, .L01DB8D74
    /* 00D094 01DB8D94 00000000 */   nop
    /* 00D098 01DB8D98 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC60)
    /* 00D09C 01DB8D9C 4008228C */  lw         $2, %lo(MainDungeonMap + 0xBC60)($1)
    /* 00D0A0 01DB8DA0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC60)
    /* 00D0A4 01DB8DA4 501322AC */  sw         $2, %lo(UraDungeonMap + 0xBC60)($1)
    /* 00D0A8 01DB8DA8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC64)
    /* 00D0AC 01DB8DAC 4408228C */  lw         $2, %lo(MainDungeonMap + 0xBC64)($1)
    /* 00D0B0 01DB8DB0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC64)
    /* 00D0B4 01DB8DB4 541322AC */  sw         $2, %lo(UraDungeonMap + 0xBC64)($1)
    /* 00D0B8 01DB8DB8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC68)
    /* 00D0BC 01DB8DBC 4808228C */  lw         $2, %lo(MainDungeonMap + 0xBC68)($1)
    /* 00D0C0 01DB8DC0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC68)
    /* 00D0C4 01DB8DC4 581322AC */  sw         $2, %lo(UraDungeonMap + 0xBC68)($1)
    /* 00D0C8 01DB8DC8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC6C)
    /* 00D0CC 01DB8DCC 4C08228C */  lw         $2, %lo(MainDungeonMap + 0xBC6C)($1)
    /* 00D0D0 01DB8DD0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC6C)
    /* 00D0D4 01DB8DD4 5C1322AC */  sw         $2, %lo(UraDungeonMap + 0xBC6C)($1)
    /* 00D0D8 01DB8DD8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC70)
    /* 00D0DC 01DB8DDC 5008228C */  lw         $2, %lo(MainDungeonMap + 0xBC70)($1)
    /* 00D0E0 01DB8DE0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC70)
    /* 00D0E4 01DB8DE4 601322AC */  sw         $2, %lo(UraDungeonMap + 0xBC70)($1)
    /* 00D0E8 01DB8DE8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC74)
    /* 00D0EC 01DB8DEC 5408228C */  lw         $2, %lo(MainDungeonMap + 0xBC74)($1)
    /* 00D0F0 01DB8DF0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC74)
    /* 00D0F4 01DB8DF4 641322AC */  sw         $2, %lo(UraDungeonMap + 0xBC74)($1)
    /* 00D0F8 01DB8DF8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC78)
    /* 00D0FC 01DB8DFC 5808228C */  lw         $2, %lo(MainDungeonMap + 0xBC78)($1)
    /* 00D100 01DB8E00 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC78)
    /* 00D104 01DB8E04 681322AC */  sw         $2, %lo(UraDungeonMap + 0xBC78)($1)
    /* 00D108 01DB8E08 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBC7C)
    /* 00D10C 01DB8E0C 5C08228C */  lw         $2, %lo(MainDungeonMap + 0xBC7C)($1)
    /* 00D110 01DB8E10 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC7C)
    /* 00D114 01DB8E14 6C1322AC */  sw         $2, %lo(UraDungeonMap + 0xBC7C)($1)
    /* 00D118 01DB8E18 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xBC80)
    /* 00D11C 01DB8E1C 60084624 */  addiu      $6, $2, %lo(MainDungeonMap + 0xBC80)
    /* 00D120 01DB8E20 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xBC80)
    /* 00D124 01DB8E24 70134524 */  addiu      $5, $2, %lo(UraDungeonMap + 0xBC80)
  ...
  .L01DB8E2C:
    ...
    /* 00D148 01DB8E48 F8FF801C */  bgtz       $4, .L01DB8E2C
    /* 00D14C 01DB8E4C 00000000 */   nop
    /* 00D150 01DB8E50 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBD80)
    /* 00D154 01DB8E54 6009228C */  lw         $2, %lo(MainDungeonMap + 0xBD80)($1)
    /* 00D158 01DB8E58 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBD80)
    /* 00D15C 01DB8E5C 701422AC */  sw         $2, %lo(UraDungeonMap + 0xBD80)($1)
    /* 00D160 01DB8E60 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBD84)
    /* 00D164 01DB8E64 6409228C */  lw         $2, %lo(MainDungeonMap + 0xBD84)($1)
    /* 00D168 01DB8E68 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBD84)
    /* 00D16C 01DB8E6C 741422AC */  sw         $2, %lo(UraDungeonMap + 0xBD84)($1)
    /* 00D170 01DB8E70 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBD88)
    /* 00D174 01DB8E74 6809228C */  lw         $2, %lo(MainDungeonMap + 0xBD88)($1)
    /* 00D178 01DB8E78 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBD88)
    /* 00D17C 01DB8E7C 781422AC */  sw         $2, %lo(UraDungeonMap + 0xBD88)($1)
    /* 00D180 01DB8E80 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xBD8C)
    /* 00D184 01DB8E84 6C094624 */  addiu      $6, $2, %lo(MainDungeonMap + 0xBD8C)
    /* 00D188 01DB8E88 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xBD8C)
    /* 00D18C 01DB8E8C 7C144524 */  addiu      $5, $2, %lo(UraDungeonMap + 0xBD8C)
  ...
  .L01DB8E94:
    ...
    /* 00D1B0 01DB8EB0 F8FF801C */  bgtz       $4, .L01DB8E94
    /* 00D1B4 01DB8EB4 00000000 */   nop
    /* 00D1B8 01DB8EB8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBDEC)
    /* 00D1BC 01DB8EBC CC09228C */  lw         $2, %lo(MainDungeonMap + 0xBDEC)($1)
    /* 00D1C0 01DB8EC0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBDEC)
    /* 00D1C4 01DB8EC4 DC1422AC */  sw         $2, %lo(UraDungeonMap + 0xBDEC)($1)
    /* 00D1C8 01DB8EC8 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xBDF0)
    /* 00D1CC 01DB8ECC E0144424 */  addiu      $4, $2, %lo(UraDungeonMap + 0xBDF0)
    /* 00D1D0 01DB8ED0 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xBDF0)
    /* 00D1D4 01DB8ED4 D0094524 */  addiu      $5, $2, %lo(MainDungeonMap + 0xBDF0)
    /* 00D1D8 01DB8ED8 240B050C */  jal        __as__13MAP_NPC_MODELFRC13MAP_NPC_MODEL
    /* 00D1DC 01DB8EDC 00000000 */   nop
    /* 00D1E0 01DB8EE0 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xD120)
    /* 00D1E4 01DB8EE4 10284424 */  addiu      $4, $2, %lo(UraDungeonMap + 0xD120)
    /* 00D1E8 01DB8EE8 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xD120)
    /* 00D1EC 01DB8EEC 001D4524 */  addiu      $5, $2, %lo(MainDungeonMap + 0xD120)
    /* 00D1F0 01DB8EF0 240B050C */  jal        __as__13MAP_NPC_MODELFRC13MAP_NPC_MODEL
    /* 00D1F4 01DB8EF4 00000000 */   nop
    /* 00D1F8 01DB8EF8 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xE450)
    /* 00D1FC 01DB8EFC 403B4424 */  addiu      $4, $2, %lo(UraDungeonMap + 0xE450)
    /* 00D200 01DB8F00 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xE450)
    /* 00D204 01DB8F04 30304524 */  addiu      $5, $2, %lo(MainDungeonMap + 0xE450)
    /* 00D208 01DB8F08 240B050C */  jal        __as__13MAP_NPC_MODELFRC13MAP_NPC_MODEL
    /* 00D20C 01DB8F0C 00000000 */   nop
    /* 00D210 01DB8F10 DE01023C */  lui        $2, %hi(UraDungeonMap + 0xF780)
    /* 00D214 01DB8F14 704E4424 */  addiu      $4, $2, %lo(UraDungeonMap + 0xF780)
    /* 00D218 01DB8F18 DD01023C */  lui        $2, %hi(MainDungeonMap + 0xF780)
    /* 00D21C 01DB8F1C 60434524 */  addiu      $5, $2, %lo(MainDungeonMap + 0xF780)
    /* 00D220 01DB8F20 240B050C */  jal        __as__13MAP_NPC_MODELFRC13MAP_NPC_MODEL
    /* 00D224 01DB8F24 00000000 */   nop
    /* 00D228 01DB8F28 DD01023C */  lui        $2, %hi(MainDungeonMap + 0x10AB0)
    /* 00D22C 01DB8F2C 90564624 */  addiu      $6, $2, %lo(MainDungeonMap + 0x10AB0)
    /* 00D230 01DB8F30 DE01023C */  lui        $2, %hi(UraDungeonMap + 0x10AB0)
    /* 00D234 01DB8F34 A0614524 */  addiu      $5, $2, %lo(UraDungeonMap + 0x10AB0)
  ...
  .L01DB8F3C:
    ...
    /* 00D258 01DB8F58 F8FF801C */  bgtz       $4, .L01DB8F3C
  ...
  .L01DB8F74:
    ...
    /* 00D290 01DB8F90 F8FF801C */  bgtz       $4, .L01DB8F74
    /* 00D294 01DB8F94 00000000 */   nop
    /* 00D298 01DB8F98 28260070 */  paddub     $4, $0, $0
    /* 00D29C 01DB8F9C 0C000010 */  b          .L01DB8FD0
  ...
  .L01DB8FD0:
    ...
    /* 00D2D4 01DB8FD4 F3FF4014 */  bnez       $2, .L01DB8FA4
    /* 00D2D8 01DB8FD8 00000000 */   nop
    /* 00D2DC 01DB8FDC 28160070 */  paddub     $2, $0, $0
    /* 00D2E0 01DB8FE0 0E000010 */  b          .L01DB901C
  ...
  .L01DB901C:
    ...
    /* 00D320 01DB9020 F1FF6014 */  bnez       $3, .L01DB8FE8
    /* 00D324 01DB9024 00000000 */   nop
    /* 00D328 01DB9028 28160070 */  paddub     $2, $0, $0
    /* 00D32C 01DB902C 0F000010 */  b          .L01DB906C
    /* 00D330 01DB9030 00000000 */   nop
  .L01DB9034:
    /* 00D334 01DB9034 80210200 */  sll        $4, $2, 6
    /* 00D338 01DB9038 DE01033C */  lui        $3, %hi(UraDungeonMap + 0xB660)
    /* 00D33C 01DB903C 500D6324 */  addiu      $3, $3, %lo(UraDungeonMap + 0xB660)
    /* 00D340 01DB9040 21186400 */  addu       $3, $3, $4
    /* 00D344 01DB9044 000060AC */  sw         $0, 0x0($3)
    /* 00D348 01DB9048 DE01033C */  lui        $3, %hi(UraDungeonMap + 0xB68C)
    /* 00D34C 01DB904C 7C0D6324 */  addiu      $3, $3, %lo(UraDungeonMap + 0xB68C)
    /* 00D350 01DB9050 21186400 */  addu       $3, $3, $4
    /* 00D354 01DB9054 000060AC */  sw         $0, 0x0($3)
    /* 00D358 01DB9058 DE01033C */  lui        $3, %hi(UraDungeonMap + 0xB690)
    /* 00D35C 01DB905C 800D6324 */  addiu      $3, $3, %lo(UraDungeonMap + 0xB690)
  ...
  .L01DB906C:
    ...
    /* 00D370 01DB9070 F0FF6014 */  bnez       $3, .L01DB9034
    /* 00D374 01DB9074 00000000 */   nop
    /* 00D378 01DB9078 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBC60)
    /* 00D37C 01DB907C 501320AC */  sw         $0, %lo(UraDungeonMap + 0xBC60)($1)
    /* 00D380 01DB9080 28160070 */  paddub     $2, $0, $0
    /* 00D384 01DB9084 07000010 */  b          .L01DB90A4
    /* 00D388 01DB9088 00000000 */   nop
  .L01DB908C:
    /* 00D38C 01DB908C 40210200 */  sll        $4, $2, 5
    /* 00D390 01DB9090 DE01033C */  lui        $3, %hi(UraDungeonMap + 0xBC94)
    /* 00D394 01DB9094 84136324 */  addiu      $3, $3, %lo(UraDungeonMap + 0xBC94)
  ...
  .L01DB90A4:
    ...
    /* 00D3A8 01DB90A8 F8FF6014 */  bnez       $3, .L01DB908C
    /* 00D3AC 01DB90AC 00000000 */   nop
    /* 00D3B0 01DB90B0 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBD80)
    /* 00D3B4 01DB90B4 701420AC */  sw         $0, %lo(UraDungeonMap + 0xBD80)($1)
    /* 00D3B8 01DB90B8 28160070 */  paddub     $2, $0, $0
    /* 00D3BC 01DB90BC 09000010 */  b          .L01DB90E4
  ...
  .L01DB90C4:
    ...
    /* 00D3D0 01DB90D0 DE01033C */  lui        $3, %hi(UraDungeonMap + 0xBD9C)
    /* 00D3D4 01DB90D4 8C146324 */  addiu      $3, $3, %lo(UraDungeonMap + 0xBD9C)
  ...
  .L01DB90E4:
    ...
    /* 00D3E8 01DB90E8 F6FF6014 */  bnez       $3, .L01DB90C4
    ...
    /* 00D408 01DB9108 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBDEC)
    /* 00D40C 01DB910C DC14268C */  lw         $6, %lo(UraDungeonMap + 0xBDEC)($1)
    ...
    /* 00D43C 01DB913C DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBDEC)
    /* 00D440 01DB9140 DC14258C */  lw         $5, %lo(UraDungeonMap + 0xBDEC)($1)
    ...
    /* 00D454 01DB9154 DE01013C */  lui        $1, %hi(UraDungeonMap + 0xBDEC)
    /* 00D458 01DB9158 DC14268C */  lw         $6, %lo(UraDungeonMap + 0xBDEC)($1)
