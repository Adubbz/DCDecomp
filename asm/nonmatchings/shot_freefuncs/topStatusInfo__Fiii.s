...
glabel topStatusInfo__Fiii
  ...
  .L001B1078:
    /* 0B1178 001B1078 CC938283 */  lb         $2, %gp_rel(init$865)($28)
    /* 0B117C 001B107C 05004014 */  bnez       $2, .L001B1094
    /* 0B1180 001B1080 00000000 */   nop
    /* 0B1184 001B1084 188680C7 */  lwc1       $f0, -0x79E8($28)
    /* 0B1188 001B1088 C89380E7 */  swc1       $f0, %gp_rel(popupYRate$864)($28)
    /* 0B118C 001B108C 01000224 */  addiu      $2, $0, 0x1
    /* 0B1190 001B1090 CC9382A3 */  sb         $2, %gp_rel(init$865)($28)
  .L001B1094:
    /* 0B1194 001B1094 C89381C7 */  lwc1       $f1, %gp_rel(popupYRate$864)($28)
    /* 0B1198 001B1098 C08180C7 */  lwc1       $f0, -0x7E40($28)
    /* 0B119C 001B109C 40080046 */  add.s      $f1, $f1, $f0
    /* 0B11A0 001B10A0 C89381E7 */  swc1       $f1, %gp_rel(popupYRate$864)($28)
    ...
    /* 0B11B8 001B10B8 C89381C7 */  lwc1       $f1, %gp_rel(popupYRate$864)($28)
    /* 0B11BC 001B10BC 1C8680C7 */  lwc1       $f0, -0x79E4($28)
    /* 0B11C0 001B10C0 01080046 */  sub.s      $f0, $f1, $f0
    /* 0B11C4 001B10C4 C89380E7 */  swc1       $f0, %gp_rel(popupYRate$864)($28)
  .L001B10C8:
    /* 0B11C8 001B10C8 D4938283 */  lb         $2, %gp_rel(init$870)($28)
    /* 0B11CC 001B10CC 05004014 */  bnez       $2, .L001B10E4
    /* 0B11D0 001B10D0 00000000 */   nop
    /* 0B11D4 001B10D4 208680C7 */  lwc1       $f0, -0x79E0($28)
    /* 0B11D8 001B10D8 D09380E7 */  swc1       $f0, %gp_rel(popupRGBRate$869)($28)
    /* 0B11DC 001B10DC 01000224 */  addiu      $2, $0, 0x1
    /* 0B11E0 001B10E0 D49382A3 */  sb         $2, %gp_rel(init$870)($28)
  .L001B10E4:
    /* 0B11E4 001B10E4 D09381C7 */  lwc1       $f1, %gp_rel(popupRGBRate$869)($28)
    /* 0B11E8 001B10E8 248680C7 */  lwc1       $f0, -0x79DC($28)
    /* 0B11EC 001B10EC 40080046 */  add.s      $f1, $f1, $f0
    /* 0B11F0 001B10F0 D09381E7 */  swc1       $f1, %gp_rel(popupRGBRate$869)($28)
    ...
    /* 0B120C 001B110C D09381C7 */  lwc1       $f1, %gp_rel(popupRGBRate$869)($28)
    /* 0B1210 001B1110 B08080C7 */  lwc1       $f0, -0x7F50($28)
    /* 0B1214 001B1114 01080046 */  sub.s      $f0, $f1, $f0
    /* 0B1218 001B1118 D09380E7 */  swc1       $f0, %gp_rel(popupRGBRate$869)($28)
  .L001B111C:
  ...
  .L001B1130:
    ...
    /* 0B125C 001B115C D0938CC7 */  lwc1       $f12, %gp_rel(popupRGBRate$869)($28)
