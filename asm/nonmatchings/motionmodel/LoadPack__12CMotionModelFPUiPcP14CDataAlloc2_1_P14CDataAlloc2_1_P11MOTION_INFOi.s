...
glabel LoadPack__12CMotionModelFPUiPcP14CDataAlloc2_1_P14CDataAlloc2_1_P11MOTION_INFOi
    ...
    /* 0B6BBC 001B6ABC 2A00023C */  lui        $2, %hi("@863")
    /* 0B6BC0 001B6AC0 38BB4524 */  addiu      $5, $2, %lo("@863")
    /* 0B6BC4 001B6AC4 BC14040C */  jal        strcat
    /* 0B6BC8 001B6AC8 00000000 */   nop
    /* 0B6BCC 001B6ACC 1001A427 */  addiu      $4, $29, 0x110
    /* 0B6BD0 001B6AD0 2A00023C */  lui        $2, %hi("@864")
    /* 0B6BD4 001B6AD4 40BB4524 */  addiu      $5, $2, %lo("@864")
    /* 0B6BD8 001B6AD8 BC14040C */  jal        strcat
    /* 0B6BDC 001B6ADC 00000000 */   nop
    /* 0B6BE0 001B6AE0 5001A427 */  addiu      $4, $29, 0x150
    /* 0B6BE4 001B6AE4 2A00023C */  lui        $2, %hi("@865")
    /* 0B6BE8 001B6AE8 48BB4524 */  addiu      $5, $2, %lo("@865")
    /* 0B6BEC 001B6AEC BC14040C */  jal        strcat
    /* 0B6BF0 001B6AF0 00000000 */   nop
    /* 0B6BF4 001B6AF4 9001A427 */  addiu      $4, $29, 0x190
    /* 0B6BF8 001B6AF8 2A00023C */  lui        $2, %hi("@866")
    /* 0B6BFC 001B6AFC 50BB4524 */  addiu      $5, $2, %lo("@866")
  ...
  .L001B6B18:
    ...
    /* 0B6C38 001B6B38 2A00023C */  lui        $2, %hi("@867")
    /* 0B6C3C 001B6B3C 60BB4424 */  addiu      $4, $2, %lo("@867")
  ...
  .L001B6B58:
    ...
    /* 0B6C78 001B6B78 2A00023C */  lui        $2, %hi("@868")
    /* 0B6C7C 001B6B7C 78BB4424 */  addiu      $4, $2, %lo("@868")
