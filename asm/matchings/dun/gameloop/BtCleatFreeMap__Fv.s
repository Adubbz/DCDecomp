...
glabel BtCleatFreeMap__Fv
    ...
    /* 00D4C8 01DB91C8 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBDEC)
    /* 00D4CC 01DB91CC CC09268C */  lw         $6, %lo(MainDungeonMap + 0xBDEC)($1)
    ...
    /* 00D4FC 01DB91FC DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBDEC)
    /* 00D500 01DB9200 CC09258C */  lw         $5, %lo(MainDungeonMap + 0xBDEC)($1)
    ...
    /* 00D514 01DB9214 DD01013C */  lui        $1, %hi(MainDungeonMap + 0xBDEC)
    /* 00D518 01DB9218 CC09268C */  lw         $6, %lo(MainDungeonMap + 0xBDEC)($1)
    ...
    /* 00D53C 01DB923C 10000010 */  b          .L01DB9280
  ...
  .L01DB9280:
    ...
    /* 00D584 01DB9284 EFFF4014 */  bnez       $2, .L01DB9244
