...
glabel LIT_994__3
    ...
    /* 01717C 01DC2E7C 20DADA01 */ .word .L01DADA20
    /* 017180 01DC2E80 44DADA01 */ .word .L01DADA44
    /* 017184 01DC2E84 D0DADA01 */ .word .L01DADAD0
    /* 017188 01DC2E88 ECDADA01 */ .word .L01DADAEC
    /* 01718C 01DC2E8C 94DADA01 */ .word .L01DADA94
...
glabel GameLoop__Fv
  ...
  .L01DADA44:
    ...
    /* 001D50 01DADA50 26004310 */  beq        $2, $3, .L01DADAEC
    /* 001D54 01DADA54 00000000 */   nop
    /* 001D58 01DADA58 D501013C */  lui        $1, (0x1D567C4 >> 16)
    /* 001D5C 01DADA5C C467238C */  lw         $3, (0x1D567C4 & 0xFFFF)($1)
    /* 001D60 01DADA60 02006010 */  beqz       $3, .L01DADA6C
    /* 001D64 01DADA64 00000000 */   nop
    /* 001D68 01DADA68 040062AC */  sw         $2, 0x4($3)
  .L01DADA6C:
    /* 001D6C 01DADA6C D501013C */  lui        $1, (0x1D567C4 >> 16)
    /* 001D70 01DADA70 C46720AC */  sw         $0, (0x1D567C4 & 0xFFFF)($1)
    ...
    /* 001D8C 01DADA8C 17000010 */  b          .L01DADAEC
    /* 001D90 01DADA90 00000000 */   nop
  .L01DADA94:
    /* 001D94 01DADA94 D83C080C */  jal        DngEscapeMsgLoop__Fv
    /* 001D98 01DADA98 00000000 */   nop
    /* 001D9C 01DADA9C 13004018 */  blez       $2, .L01DADAEC
    /* 001DA0 01DADAA0 00000000 */   nop
    /* 001DA4 01DADAA4 D501013C */  lui        $1, (0x1D567C8 >> 16)
    /* 001DA8 01DADAA8 C867238C */  lw         $3, (0x1D567C8 & 0xFFFF)($1)
    /* 001DAC 01DADAAC 02006010 */  beqz       $3, .L01DADAB8
    /* 001DB0 01DADAB0 00000000 */   nop
    /* 001DB4 01DADAB4 040062AC */  sw         $2, 0x4($3)
  .L01DADAB8:
    /* 001DB8 01DADAB8 D501013C */  lui        $1, (0x1D567C8 >> 16)
    /* 001DBC 01DADABC C86720AC */  sw         $0, (0x1D567C8 & 0xFFFF)($1)
    /* 001DC0 01DADAC0 01000224 */  addiu      $2, $0, 0x1
    /* 001DC4 01DADAC4 6C9D82AF */  sw         $2, -0x6294($28)
    /* 001DC8 01DADAC8 08000010 */  b          .L01DADAEC
  ...
  .L01DADAD0:
    ...
    /* 001DDC 01DADADC 03004010 */  beqz       $2, .L01DADAEC
  ...
  .L01DADAEC:
    ...
    /* 001DF0 01DADAF0 3B004010 */  beqz       $2, .L01DADBE0
  ...
  .L01DADAF8:
    ...
    /* 001E04 01DADB04 FCFF4310 */  beq        $2, $3, .L01DADAF8
    /* 001E08 01DADB08 00000000 */   nop
    /* 001E0C 01DADB0C D401013C */  lui        $1, (0x1D40000 >> 16)
    /* 001E10 01DADB10 00D2228C */  lw         $2, -0x2E00($1)
    /* 001E14 01DADB14 07004010 */  beqz       $2, .L01DADB34
    ...
    /* 001E2C 01DADB2C 03000010 */  b          .L01DADB3C
  ...
  .L01DADB3C:
    ...
    /* 001E60 01DADB60 D501013C */  lui        $1, (0x1D567F8 >> 16)
    /* 001E64 01DADB64 F867228C */  lw         $2, (0x1D567F8 & 0xFFFF)($1)
    /* 001E68 01DADB68 15004014 */  bnez       $2, .L01DADBC0
    /* 001E6C 01DADB6C 00000000 */   nop
    /* 001E70 01DADB70 789C858F */  lw         $5, -0x6388($28)
    /* 001E74 01DADB74 28260070 */  paddub     $4, $0, $0
    /* 001E78 01DADB78 0A000010 */  b          .L01DADBA4
  ...
  .L01DADBA4:
    ...
    /* 001EA8 01DADBA8 F5FF4014 */  bnez       $2, .L01DADB80
  ...
  .L01DADBC0:
    ...
    /* 001ED8 01DADBD8 14000010 */  b          .L01DADC2C
    /* 001EDC 01DADBDC 00000000 */   nop
  .L01DADBE0:
    /* 001EE0 01DADBE0 049E828F */  lw         $2, -0x61FC($28)
    /* 001EE4 01DADBE4 0E004010 */  beqz       $2, .L01DADC20
  ...
  .L01DADBEC:
    ...
    /* 001EF8 01DADBF8 FCFF4310 */  beq        $2, $3, .L01DADBEC
    ...
    /* 001F18 01DADC18 04000010 */  b          .L01DADC2C
