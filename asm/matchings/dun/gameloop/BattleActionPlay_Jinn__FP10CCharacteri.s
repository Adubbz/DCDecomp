...
glabel BattleActionPlay_Jinn__FP10CCharacteri
    ...
    /* 010C74 01DBC974 02004010 */  beqz       $2, .L01DBC980
  ...
  .L01DBC980:
    ...
    /* 010C8C 01DBC98C 29008314 */  bne        $4, $3, .L01DBCA34
    ...
    /* 010CA8 01DBC9A8 04004014 */  bnez       $2, .L01DBC9BC
  ...
  .L01DBC9BC:
    ...
    /* 010D0C 01DBCA0C 06006014 */  bnez       $3, .L01DBCA28
    ...
    /* 010D20 01DBCA20 04000010 */  b          .L01DBCA34
  ...
  .L01DBCA34:
    ...
    /* 010D40 01DBCA40 07018314 */  bne        $4, $3, .L01DBCE60
    ...
    /* 010D50 01DBCA50 88004016 */  bnez       $18, .L01DBCC74
    ...
    /* 010D6C 01DBCA6C DD000145 */  bc1t       .L01DBCDE4
    ...
    /* 010D88 01DBCA88 D6000045 */  bc1f       .L01DBCDE4
    ...
    /* 010DB8 01DBCAB8 DC01023C */  lui        $2, %hi("@5687")
    /* 010DBC 01DBCABC C0284224 */  addiu      $2, $2, %lo("@5687")
    ...
    /* 010DD4 01DBCAD4 DC01023C */  lui        $2, %hi("@5735")
    /* 010DD8 01DBCAD8 98334524 */  addiu      $5, $2, %lo("@5735")
    /* 010DDC 01DBCADC C0A1040C */  jal        SearchFrame__6CFrameFPc
    /* 010DE0 01DBCAE0 00000000 */   nop
    /* 010DE4 01DBCAE4 5C004010 */  beqz       $2, .L01DBCC58
    ...
    /* 010E04 01DBCB04 0E004014 */  bnez       $2, .L01DBCB40
    ...
    /* 010E38 01DBCB38 21000010 */  b          .L01DBCBC0
  ...
  .L01DBCBC0:
    ...
    /* 010EC8 01DBCBC8 1E000010 */  b          .L01DBCC44
  ...
  .L01DBCBD0:
    ...
    /* 010EE0 01DBCBE0 17004014 */  bnez       $2, .L01DBCC40
  ...
  .L01DBCC58:
    ...
    /* 010F6C 01DBCC6C 5D000010 */  b          .L01DBCDE4
  ...
  .L01DBCC74:
    ...
    /* 010F88 01DBCC88 56000145 */  bc1t       .L01DBCDE4
    ...
    /* 010FA4 01DBCCA4 4F000045 */  bc1f       .L01DBCDE4
    ...
    /* 010FD4 01DBCCD4 DC01023C */  lui        $2, %hi("@5697")
    /* 010FD8 01DBCCD8 D0284224 */  addiu      $2, $2, %lo("@5697")
    ...
    /* 010FF0 01DBCCF0 DC01023C */  lui        $2, %hi("@5735")
    /* 010FF4 01DBCCF4 98334524 */  addiu      $5, $2, %lo("@5735")
    /* 010FF8 01DBCCF8 C0A1040C */  jal        SearchFrame__6CFrameFPc
    /* 010FFC 01DBCCFC 00000000 */   nop
    /* 011000 01DBCD00 33004010 */  beqz       $2, .L01DBCDD0
    ...
    /* 011040 01DBCD40 1E000010 */  b          .L01DBCDBC
  ...
  .L01DBCD48:
    ...
    /* 011058 01DBCD58 17004014 */  bnez       $2, .L01DBCDB8
  ...
  .L01DBCDE4:
    ...
    /* 01113C 01DBCE3C 04006010 */  beqz       $3, .L01DBCE50
  ...
  .L01DBCE50:
    ...
    /* 011158 01DBCE58 01008314 */  bne        $4, $3, .L01DBCE60
  ...
  .L01DBCE60:
    ...
    /* 01116C 01DBCE6C 18008314 */  bne        $4, $3, .L01DBCED0
    ...
    /* 011188 01DBCE88 04004014 */  bnez       $2, .L01DBCE9C
  ...
  .L01DBCE9C:
    ...
    /* 0111B8 01DBCEB8 05006010 */  beqz       $3, .L01DBCED0
