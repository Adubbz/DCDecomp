...
glabel StoreImage__Fv
  ...
  .L0012C82C:
    ...
    /* 02C948 0012C848 2A00023C */  lui        $2, %hi("@250")
    /* 02C94C 0012C84C 088E4424 */  addiu      $4, $2, %lo("@250")
  ...
  .L0012C87C:
    ...
    /* 02C988 0012C888 2A00023C */  lui        $2, %hi("@251")
    /* 02C98C 0012C88C 208E4524 */  addiu      $5, $2, %lo("@251")
    ...
    /* 02C9A8 0012C8A8 2A00023C */  lui        $2, %hi("@252")
    /* 02C9AC 0012C8AC 388E4524 */  addiu      $5, $2, %lo("@252")
