 ...
 * @unknownret
 */
void _CHK_ROTATION(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _CHK_USER_INNER_PRODUCT(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _GET_VECTOR(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _STATUS_GET_HEIGHT(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _STATUS_GET_HITDMG_VOL(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _STATUS_GET_DMG_ID(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _STATUS_SET_LOCKON_TRG(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _SET_DMG_PARA(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _GET_COL_HIT_ID(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _GET_GLOBAL_INT(RS_STACKDATA *, int);
 ...
 */
void _GET_OBJ_POS(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _CHEKC_FADE_OUT(RS_STACKDATA *, int);
 ...
 * @unknownret
 */
void _SET_REFERENCE(RS_STACKDATA *, int);
