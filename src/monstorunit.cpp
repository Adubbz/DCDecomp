...
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_653__3);
...
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_915);
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_916);
INCLUDE_ASM("asm/nonmatchings/monstorunit", DrawBee__FP6CFramei);
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_935);
...
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_1518);
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_1521);
...
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_2233__2);
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_2237__2);
...
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_2328);
INCLUDE_RODATA("asm/nonmatchings/monstorunit", LIT_2329);
