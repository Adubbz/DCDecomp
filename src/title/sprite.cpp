...
void CSprite::Move()
{
    ...
    if (x[0] < 700.0f) {
        if (x[0] < 700.0f) { target_x = 700.0f; target_y = 94.0f; }
        if (x[0] < 510.0f) { target_x = 510.0f; target_y = 154.0f; }
        if (x[0] < 400.0f) { target_x = 400.0f; target_y = 194.0f; }
        if (x[0] < 320.0f) { target_x = 320.0f; target_y = 154.0f; }
        if (x[0] < 230.0f) { target_x = 250.0f; target_y = 94.0f; }
        if (x[0] < 150.0f) { target_x = 150.0f; target_y = 154.0f; }

        angle = (float)atan2(target_x - x[0], target_y - y[0]);
        if (this->angle > angle) this->angle = this->angle - 0.08f;
        if (this->angle < angle) this->angle += 0.08f;
