...
static void MotionProcess()
{
        ...
        if (CScript.obj[i].disp) {
            if (CScript.obj[i].motion_end != -1) {
                if (Chara[i].motion_type.state.time
                        > (float)(Chara[i].motion_type.motion_info[CScript.obj[i].motion]
                                   .end - 1)) {
    ...
    case 0: Wind.SetVelocity(1.3f); break;
    case 1: Wind.SetVelocity(0.4f); break;
    case 2: Wind.SetVelocity(0.4f); break;
    case 3: Wind.SetVelocity(0.4f); break;
    case 4: Wind.SetVelocity(0.0f); break;
    case 5: Wind.SetVelocity(0.4f); break;
    case 6: Wind.SetVelocity(0.4f); break;
    case 7: Wind.SetVelocity(0.4f); break;
    case 8: Wind.SetVelocity(0.4f); break;
    case 9: Wind.SetVelocity(0.3f); break;
    }
    ...
    for (int i = 0; i < 9; i++) {
        if (CScript.obj[i].disp) {
            ...
            if (frame) {
                if (CScript.scene == 0 || CScript.camera_start == 16
                    || (CScript.camera_start == 17 && i == 0)) {
...
static void DrawProcess()
{
    ...
    switch (CScript.scene) {
    case 0: DrawProcA(); break;
    case 1: DrawProcB(); break;
    case 2: DrawProcC(); break;
    case 3: DrawProcD(); break;
    case 4: DrawProcE(); break;
    case 5: DrawProcF(); break;
    case 6: DrawProcG(); break;
    case 7: DrawProcH(); break;
    case 8: DrawProcI(); break;
    case 9: DrawProcTitle(); break;
    }
...
static void SoundProcess()
{
    ...
    if ((CScript.scene == 0 && Cam[SceneNp].motion_type.state.time > 10.0f)
        || (CScript.scene == 7 && Cam[SceneNp].motion_type.state.time > 10.0f)) {
        static int wait = 0;
